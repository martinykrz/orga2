...
void screen_draw_layout(void) {
  ...
  for (uint32_t f = 0; f < VIDEO_FILS; f++) {
    for (uint32_t c = 0; c < VIDEO_COLS; c++) {
        p[f][c].c = 32;
        p[f][c].a = C_FG_BLACK + C_BG_BLACK;
    }
  }
  uint8_t attr = C_FG_GREEN + C_BG_BLACK;
  const char* text = "Change Color Help\nForeground (Key, Shift+Key)\nF01: Black, Dark Grey\nF02: Blue, Light Blue\nF03: Green, Light Green\nF04: Cyan, Light Cyan\nF05: Red, Light Red\nF06: Magenta, Light Magenta\nF07: Brown, Light Brown\nF08: White, Light Grey\nBackground (Key, Shift+Key)\nF09: Black, Light Grey\nF10: Blue, Brown\nF11: Red, Green\nF12: Cyan, Magenta\n";
  print(text, 0, 0, attr);
}
